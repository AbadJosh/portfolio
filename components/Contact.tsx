...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ background: "#050b18", padding: "100px 0" }}>
      <style>{`
        ...
        .ct-input::placeholder { color: #243650; }
        .ct-input:disabled { opacity: 0.4; cursor: not-allowed; }
        .ct-social {
          width: 44px; height: 44px; border-radius: 10px;
          background: #060d1f; border: 1.5px solid #1e3a5f;
          display: flex; align-items: center; justify-content: center;
          color: #334155; text-decoration: none;
          transition: border-color 0.25s, color 0.25s, box-shadow 0.25s;
        }
        .ct-social:hover { border-color: #3b82f6; color: #3b82f6; box-shadow: 0 0 16px rgba(59,130,246,0.3); }
        .ct-info-card {
        ...
        <div className="ct-grid">
          ...
          >
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <label style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.09em", textTransform: "uppercase", color: "#475569" }}>
                  Name
                </label>
                <input
                  type="text" required className="ct-input"
                  value={form.name}
                  onChange={(e) => setForm({ ...form, name: e.target.value })}
                  disabled={isBusy} placeholder="Your name" suppressHydrationWarning
                />
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <input
                  type="email" required className="ct-input"
                  value={form.email}
                  onChange={(e) => setForm({ ...form, email: e.target.value })}
                  disabled={isBusy} placeholder="your@email.com" suppressHydrationWarning
                />
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                <textarea
                  required rows={6} className="ct-input"
                  value={form.message}
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", paddingTop: 4 }}>
                ...
                >
                  {status === "sending" ? (
                    <>
                      <Loader2 size={14} style={{ animation: "ct-spin 1s linear infinite" }} />
                      Sending...
                    </>
          ...
          >
            ...
            <div style={{
              ...
              boxShadow: "0 0 18px rgba(16,185,129,0.1)",
            }}>
              <span style={{
            ...
            <a href="mailto:joshua.abad.development@gmail.com" style={{ textDecoration: "none" }}>
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.boxShadow = "0 0 30px rgba(59,130,246,0.16)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget as HTMLDivElement;
                  el.style.borderColor = "rgba(59,130,246,0.18)";
                  el.style.boxShadow = "0 0 20px rgba(59,130,246,0.06)";
                }}
              >
                <div style={{
            ...
            >
              <div style={{
                ...
                <MapPin size={18} style={{ color: "#8b5cf6", filter: "drop-shadow(0 0 5px #8b5cf6)" }} />
              </div>
              <div>
                <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#334155", marginBottom: 4 }}>
                  Location
            ...
            <div style={{
              ...
              <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#334155", marginBottom: 16 }}>
                Connect
              </p>
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <a href="mailto:joshua.abad.development@gmail.com" className="ct-social" aria-label="Email">
                  <Mail size={18} />
                </a>
              </div>
            </div>
